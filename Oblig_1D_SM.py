...
plt.figure()
plt.plot(r, Cr1_exp, label = 'Experimental values', color = 'mediumseagreen' )
plt.plot(r, Cr1_t, label = 'Theoretical values', color = 'salmon')
...
plt.figure()
plt.plot(r, Cr2_exp, label = 'Experimental values', color = 'mediumseagreen' )
plt.plot(r, Cr2_t, label = 'Theoretical values', color = 'salmon')
